...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/jwebsocket.css">
		<script src="${pageContext.request.contextPath}/js/jWebSocket.js" type="text/javascript"></script>
		<script type="text/javascript" language="JavaScript">
			...
			function logon() {
				...
				//alert("jws->" + jws.getDefaultServerURL());
