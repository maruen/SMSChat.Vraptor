...
<html>
<head>
<title>Usuário: ${userSession.user.username}, Server: {userSession.config.servername}</title>
...
<link rel="stylesheet" type="text/css" href="/SMSChat/css/chat.css" />
...
//         }  
		...
		function openSMSSimulatorPage() {
			window.open('../chat/SMSSimulator.jsp','mywin','left=(screen.width-500)/2,top=(screen.height-500)/2,width=500,height=500,toolbar=1,resizable=0');
		}
